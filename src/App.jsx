...
import {
  MAX_ATTACHMENT_SIZE, DEPT_COLORS, USERS,
...
import { registerPush, sendPushNotification, sendEmailNotification, sendWhatsAppNotification, sendSMSNotification, downloadAttachmentIOS } from "./lib/notifications";
...
// Funciones de notificaciones movidas a src/lib/notifications.js
    ...
    <div style={{minHeight:"100vh",background:BG}}>
      <NavBar left={<><BackBtn onClick={onBack}/><div>
        ...
        right={<div style={{display:"flex",gap:8}}>
          ...
          {user&&!task.pausedForPayment&&<button onClick={()=>{setShowPauseForm(true);setPauseNote("");setShowBlockForm(false);setShowCancelForm(false);}} style={{background:"#FFFBEB",color:"#D97706",border:"1px solid #FDE68A",padding:"7px 14px",borderRadius:8,cursor:"pointer",fontSize:12,fontWeight:600}}>⏸{isMobile?"":" Pausar por pago"}</button>}
          {user&&task.pausedForPayment&&<button onClick={()=>{onUpdate(taskId,{pausedForPayment:false,pausedAt:null,pausedBy:null,pausedNote:""});}} style={{background:"#ECFDF5",color:"#059669",border:"1px solid #A7F3D0",padding:"7px 14px",borderRadius:8,cursor:"pointer",fontSize:12,fontWeight:600}}>▶️{isMobile?"":" Reanudar"}</button>}
